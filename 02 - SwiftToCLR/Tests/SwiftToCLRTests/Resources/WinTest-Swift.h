...
#ifndef WINTEST_SWIFT_H
#define WINTEST_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="WinTest",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
#undef SWIFT_SYMBOL
#endif
#define SWIFT_SYMBOL(usrValue) SWIFT_SYMBOL_MODULE_USR("WinTest", usrValue)
#ifndef SWIFT_PRINTED_CORE
#define SWIFT_PRINTED_CORE
namespace swift SWIFT_PRIVATE_ATTR {
...
#endif
#ifdef __cplusplus
namespace WinTest SWIFT_PRIVATE_ATTR SWIFT_SYMBOL_MODULE("WinTest") {
namespace _impl {
extern "C" {
#endif

SWIFT_EXTERN void * _Nonnull $s7WinTest8APIClassCACycfC(SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // init()
// Stub struct to be used to pass/return values to/from Swift functions.
struct swift_interop_returnStub_WinTest_uint64_t_0_8_void_ptr_8_16 {
  uint64_t _1;
  void * _Nullable _2;
};

static SWIFT_C_INLINE_THUNK void swift_interop_returnDirect_WinTest_uint64_t_0_8_void_ptr_8_16(char * _Nonnull result, struct swift_interop_returnStub_WinTest_uint64_t_0_8_void_ptr_8_16 value) {
  memcpy(result + 0, &value._1, 8);
  memcpy(result + 8, &value._2, 8);
}

SWIFT_EXTERN struct swift_interop_returnStub_WinTest_uint64_t_0_8_void_ptr_8_16 $s7WinTest8APIClassC4textSSvg(SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
// Stub struct to be used to pass/return values to/from Swift functions.
struct swift_interop_passStub_WinTest_uint64_t_0_8_void_ptr_8_16 {
  uint64_t _1;
  void * _Nullable _2;
};

static SWIFT_C_INLINE_THUNK struct swift_interop_passStub_WinTest_uint64_t_0_8_void_ptr_8_16 swift_interop_passDirect_WinTest_uint64_t_0_8_void_ptr_8_16(const char * _Nonnull value) {
  struct swift_interop_passStub_WinTest_uint64_t_0_8_void_ptr_8_16 result;
  memcpy(&result._1, value + 0, 8);
  memcpy(&result._2, value + 8, 8);
  return result;
}

SWIFT_EXTERN struct swift_interop_returnStub_WinTest_uint64_t_0_8_void_ptr_8_16 $s7WinTest8APIClassC8sayHello2toS2S_tF(struct swift_interop_passStub_WinTest_uint64_t_0_8_void_ptr_8_16 name, SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // sayHello(to:)
// Stub struct to be used to pass/return values to/from Swift functions.
struct swift_interop_returnStub_WinTest_uint8_t_0_1 {
  uint8_t _1;
};

static SWIFT_C_INLINE_THUNK void swift_interop_returnDirect_WinTest_uint8_t_0_1(char * _Nonnull result, struct swift_interop_returnStub_WinTest_uint8_t_0_1 value) {
  memcpy(result + 0, &value._1, 1);
}

SWIFT_EXTERN struct swift_interop_returnStub_WinTest_uint8_t_0_1 $s7WinTest7APIEnumO8rawValueACSgSi_tcfC(ptrdiff_t rawValue) SWIFT_NOEXCEPT SWIFT_CALL; // init(rawValue:)
// Stub struct to be used to pass/return values to/from Swift functions.
struct swift_interop_passStub_WinTest_uint8_t_0_1 {
  uint8_t _1;
};

static SWIFT_C_INLINE_THUNK struct swift_interop_passStub_WinTest_uint8_t_0_1 swift_interop_passDirect_WinTest_uint8_t_0_1(const char * _Nonnull value) {
  struct swift_interop_passStub_WinTest_uint8_t_0_1 result;
  memcpy(&result._1, value + 0, 1);
  return result;
}

SWIFT_EXTERN ptrdiff_t $s7WinTest7APIEnumO8rawValueSivg(struct swift_interop_passStub_WinTest_uint8_t_0_1 _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
struct WinTest_APIEnum {
  _Alignas(1) char _storage[1];
};

SWIFT_EXTERN struct swift_interop_returnStub_WinTest_uint8_t_0_1 $s7WinTest9APIStructV9enumValueAA7APIEnumOvg(struct swift_interop_passStub_WinTest_uint8_t_0_1 _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN struct swift_interop_returnStub_WinTest_uint8_t_0_1 $s7WinTest9APIStructV9enumValueAcA7APIEnumO_tcfC(struct swift_interop_passStub_WinTest_uint8_t_0_1 enumValue) SWIFT_NOEXCEPT SWIFT_CALL; // init(enumValue:)
struct WinTest_APIStruct {
  _Alignas(1) char _storage[1];
};
...
class SWIFT_SYMBOL("s:7WinTest8APIClassC") APIClass;
} // end namespace 
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
static inline const constexpr bool isUsableInGenericContext<WinTest::APIClass> = true;
#pragma clang diagnostic pop
} // namespace swift
...
SWIFT_EXTERN swift::_impl::MetadataResponseTy $s7WinTest8APIClassCMa(swift::_impl::MetadataRequestTy) SWIFT_NOEXCEPT SWIFT_CALL;


} // namespace _impl

class SWIFT_SYMBOL("s:7WinTest8APIClassC") APIClass : public swift::_impl::RefCountedClass {
public:
  using RefCountedClass::RefCountedClass;
  using RefCountedClass::operator=;
  static SWIFT_INLINE_THUNK APIClass init() SWIFT_SYMBOL("s:7WinTest8APIClassCACycfc");
  SWIFT_INLINE_THUNK swift::String getText() SWIFT_SYMBOL("s:7WinTest8APIClassC4textSSvp");
  SWIFT_INLINE_THUNK swift::String sayHello(const swift::String& name) SWIFT_SYMBOL("s:7WinTest8APIClassC8sayHello2toS2S_tF");
protected:
...
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wreserved-identifier"
  typedef char $s7WinTest8APIClassCD;
  static inline constexpr $s7WinTest8APIClassCD __swift_mangled_name = 0;
#pragma clang diagnostic pop
#pragma clang diagnostic pop
};
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
struct TypeMetadataTrait<WinTest::APIClass> {
  static SWIFT_INLINE_PRIVATE_HELPER void * _Nonnull getTypeMetadata() {
    return WinTest::_impl::$s7WinTest8APIClassCMa(0)._0;
  }
};
namespace _impl{
template<>
struct implClassFor<WinTest::APIClass> { using type = WinTest::_impl::_impl_APIClass; };
} // namespace
#pragma clang diagnostic pop
} // namespace swift
...
class SWIFT_SYMBOL("s:7WinTest7APIEnumO") APIEnum;
} // end namespace 
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
static inline const constexpr bool isUsableInGenericContext<WinTest::APIEnum> = true;
#pragma clang diagnostic pop
} // namespace swift
...
SWIFT_EXTERN swift::_impl::MetadataResponseTy $s7WinTest7APIEnumOMa(swift::_impl::MetadataRequestTy) SWIFT_NOEXCEPT SWIFT_CALL;


} // namespace _impl

class SWIFT_SYMBOL("s:7WinTest7APIEnumO") APIEnum final {
public:
  SWIFT_INLINE_THUNK ~APIEnum() noexcept {
    auto metadata = _impl::$s7WinTest7APIEnumOMa(0);
    auto *vwTableAddr = reinterpret_cast<swift::_impl::ValueWitnessTable **>(metadata._0) - 1;
#ifdef __arm64e__
    auto *vwTable = reinterpret_cast<swift::_impl::ValueWitnessTable *>(ptrauth_auth_data(reinterpret_cast<void *>(*vwTableAddr), ptrauth_key_process_independent_data, ptrauth_blend_discriminator(vwTableAddr, 11839)));
#else
  ...
  enum class cases {
    caseOne SWIFT_SYMBOL("s:7WinTest7APIEnumO7caseOneyA2CmF"),
    caseTwo SWIFT_SYMBOL("s:7WinTest7APIEnumO7caseTwoyA2CmF")
  };
...
#pragma clang diagnostic pop
  ...
  static SWIFT_INLINE_THUNK swift::Optional<APIEnum> init(swift::Int rawValue) SWIFT_SYMBOL("s:7WinTest7APIEnumO8rawValueACSgSi_tcfc");
  SWIFT_INLINE_THUNK swift::Int getRawValue() const SWIFT_SYMBOL("s:7WinTest7APIEnumO8rawValueSivp");
private:
  SWIFT_INLINE_THUNK APIEnum() noexcept {}
...
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wreserved-identifier"
  typedef char $s7WinTest7APIEnumOD;
  static inline constexpr $s7WinTest7APIEnumOD __swift_mangled_name = 0;
#pragma clang diagnostic pop
#pragma clang diagnostic pop
};
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
struct TypeMetadataTrait<WinTest::APIEnum> {
  static SWIFT_INLINE_PRIVATE_HELPER void * _Nonnull getTypeMetadata() {
    return WinTest::_impl::$s7WinTest7APIEnumOMa(0)._0;
  }
};
namespace _impl{
template<>
static inline const constexpr bool isValueType<WinTest::APIEnum> = true;
template<>
struct implClassFor<WinTest::APIEnum> { using type = WinTest::_impl::_impl_APIEnum; };
} // namespace
#pragma clang diagnostic pop
} // namespace swift
...
class SWIFT_SYMBOL("s:7WinTest9APIStructV") APIStruct;
} // end namespace 
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
static inline const constexpr bool isUsableInGenericContext<WinTest::APIStruct> = true;
#pragma clang diagnostic pop
} // namespace swift
...
SWIFT_EXTERN swift::_impl::MetadataResponseTy $s7WinTest9APIStructVMa(swift::_impl::MetadataRequestTy) SWIFT_NOEXCEPT SWIFT_CALL;


} // namespace _impl

class SWIFT_SYMBOL("s:7WinTest9APIStructV") APIStruct final {
public:
  SWIFT_INLINE_THUNK ~APIStruct() noexcept {
    auto metadata = _impl::$s7WinTest9APIStructVMa(0);
    auto *vwTableAddr = reinterpret_cast<swift::_impl::ValueWitnessTable **>(metadata._0) - 1;
#ifdef __arm64e__
    auto *vwTable = reinterpret_cast<swift::_impl::ValueWitnessTable *>(ptrauth_auth_data(reinterpret_cast<void *>(*vwTableAddr), ptrauth_key_process_independent_data, ptrauth_blend_discriminator(vwTableAddr, 11839)));
#else
  ...
  SWIFT_INLINE_THUNK APIEnum getEnumValue() const SWIFT_SYMBOL("s:7WinTest9APIStructV9enumValueAA7APIEnumOvp");
  static SWIFT_INLINE_THUNK APIStruct init(const APIEnum& enumValue) SWIFT_SYMBOL("s:7WinTest9APIStructV9enumValueAcA7APIEnumO_tcfc");
private:
  SWIFT_INLINE_THUNK APIStruct() noexcept {}
...
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wreserved-identifier"
  typedef char $s7WinTest9APIStructVD;
  static inline constexpr $s7WinTest9APIStructVD __swift_mangled_name = 0;
#pragma clang diagnostic pop
#pragma clang diagnostic pop
};
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
struct TypeMetadataTrait<WinTest::APIStruct> {
  static SWIFT_INLINE_PRIVATE_HELPER void * _Nonnull getTypeMetadata() {
    return WinTest::_impl::$s7WinTest9APIStructVMa(0)._0;
  }
};
namespace _impl{
template<>
static inline const constexpr bool isValueType<WinTest::APIStruct> = true;
template<>
struct implClassFor<WinTest::APIStruct> { using type = WinTest::_impl::_impl_APIStruct; };
} // namespace
#pragma clang diagnostic pop
} // namespace swift
...
namespace WinTest SWIFT_PRIVATE_ATTR SWIFT_SYMBOL_MODULE("WinTest") {
  ...
  return _impl::_impl_APIClass::makeRetained(_impl::$s7WinTest8APIClassCACycfC(swift::TypeMetadataTrait<APIClass>::getTypeMetadata()));
  }
...
#endif
struct FTypeAddress {
decltype(_impl::$s7WinTest8APIClassC4textSSvg) * func;
};
FTypeAddress *fptrptr_ = reinterpret_cast<FTypeAddress *>(vtable_ + 64 / sizeof(void *));
  return swift::_impl::_impl_String::returnNewValue([&](char * _Nonnull result) SWIFT_INLINE_THUNK_ATTRIBUTES {
    _impl::swift_interop_returnDirect_WinTest_uint64_t_0_8_void_ptr_8_16(result, (* fptrptr_->func)(::swift::_impl::_impl_RefCountedClass::getOpaquePointer(*this)));
  });
  }
...
#endif
struct FTypeAddress {
decltype(_impl::$s7WinTest8APIClassC8sayHello2toS2S_tF) * func;
};
FTypeAddress *fptrptr_ = reinterpret_cast<FTypeAddress *>(vtable_ + 72 / sizeof(void *));
  return swift::_impl::_impl_String::returnNewValue([&](char * _Nonnull result) SWIFT_INLINE_THUNK_ATTRIBUTES {
    _impl::swift_interop_returnDirect_WinTest_uint64_t_0_8_void_ptr_8_16(result, (* fptrptr_->func)(_impl::swift_interop_passDirect_WinTest_uint64_t_0_8_void_ptr_8_16(swift::_impl::_impl_String::getOpaquePointer(name)), ::swift::_impl::_impl_RefCountedClass::getOpaquePointer(*this)));
  });
  }
  ...
  return swift::_impl::_impl_Optional<APIEnum>::returnNewValue([&](char * _Nonnull result) SWIFT_INLINE_THUNK_ATTRIBUTES {
    _impl::swift_interop_returnDirect_WinTest_uint8_t_0_1(result, _impl::$s7WinTest7APIEnumO8rawValueACSgSi_tcfC(rawValue));
  });
  }
  SWIFT_INLINE_THUNK swift::Int APIEnum::getRawValue() const {
  return _impl::$s7WinTest7APIEnumO8rawValueSivg(_impl::swift_interop_passDirect_WinTest_uint8_t_0_1(_getOpaquePointer()));
  }
  ...
  return _impl::_impl_APIEnum::returnNewValue([&](char * _Nonnull result) SWIFT_INLINE_THUNK_ATTRIBUTES {
    _impl::swift_interop_returnDirect_WinTest_uint8_t_0_1(result, _impl::$s7WinTest9APIStructV9enumValueAA7APIEnumOvg(_impl::swift_interop_passDirect_WinTest_uint8_t_0_1(_getOpaquePointer())));
  });
  }
  ...
  return _impl::_impl_APIStruct::returnNewValue([&](char * _Nonnull result) SWIFT_INLINE_THUNK_ATTRIBUTES {
    _impl::swift_interop_returnDirect_WinTest_uint8_t_0_1(result, _impl::$s7WinTest9APIStructV9enumValueAcA7APIEnumO_tcfC(_impl::swift_interop_passDirect_WinTest_uint8_t_0_1(_impl::_impl_APIEnum::getOpaquePointer(enumValue))));
  });
  }
